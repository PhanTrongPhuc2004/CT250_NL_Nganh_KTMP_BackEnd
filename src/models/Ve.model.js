...
const VeSchema = new mongoose.Schema({
    maVe: { type: String, required: true, unique: true, default: () => generateCode('VE') },
    maTranDau: { type: String, ref: 'TranDau', required: true },
    maNguoiDung: { type: mongoose.Schema.Types.ObjectId, ref: 'NguoiDung' },
    maCauHinhVe: { type: String, ref: 'CauHinhVe', required: true },
    ...
    // CHỈ CÒN 3 TRẠNG THÁI CHUẨN
    trangThai: {
        type: String,
        enum: ['cho_thanh_toan', 'da_thanh_toan', 'da_vao_san'],
